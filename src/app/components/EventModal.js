      ...
      >
        <div className="flex flex-col md:flex-row justify-between border-b- p-4">
          <div className="md:w-2/3">
            <h2 className="text-[22px] truncate max-w-full text-[#1E232A] font-[600] mb-2">
              {selectedEvent.title}
            </h2>
            <p className="text-[#9AA8BD] text-[18px] font-inter mb-0 ">
              Category:{" "}
              <span className="uppercase text-[#9AA8BD] font-[600] text-[18px] font-inter">
                {selectedEvent.category}
              </span>
            </p>
          </div>
          <div className="md:w-1/3 flex md:justify-end ">
            <p className="text-[#797D8C] text-[16px] md:pt-4 pt-0 lg:pt-1 font-[600]">
        ...
        <p className="text-[#1E232A] text-[20px] font-[400] pb-4 pl-4">
          Description:
          <br />
          <span className="text-[#9E9E9E] text-[16px]">
        ...
        <div className="items-center flex justify-center py-4">
          <div className="flex items-center gap-2">
            <Vector />
            <span className="truncate max-w-[230px] text-[#797D8C] text-[20px] font-[400] font-inter">
